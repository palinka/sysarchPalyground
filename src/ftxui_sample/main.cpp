...
// configuration step. It creates a namespace called `sysarchPalyground`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", sysarchPalyground::cmake::project_name, sysarchPalyground::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", sysarchPalyground::cmake::project_version);
      return EXIT_SUCCESS;
    }
